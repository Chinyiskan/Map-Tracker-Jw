...
export class AdminManagerWithComponents {
    ...
    _renderSalidasWithComponent() {
        ...
        renderSalidasWithComponent(this._state.salidas, container, (action, id) => {
            switch (action) {
                case 'editSalida':
                    this.editSalida(id);
                    break;
    ...
    _renderCapitanesWithComponent() {
        ...
        // Usar el componente reutilizable
        renderCapitanesWithComponent(capitanesToRender, container, (action, id) => {
            switch (action) {
                case 'edit':
...
//# sourceMappingURL=compact-card-examples.js.map