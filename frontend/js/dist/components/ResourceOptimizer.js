...
export class ResourceOptimizer {
    ...
    _addPlaceholder(img) {
        if (!img.src || img.src === '') {
            ...
            const placeholder = this._createPlaceholderSVG(img.dataset.width || 300, img.dataset.height || 200);
            img.src = placeholder;
    ...
    _onImageError(img) {
        ...
        const errorPlaceholder = this._createErrorPlaceholder(img.dataset.width || 300, img.dataset.height || 200);
