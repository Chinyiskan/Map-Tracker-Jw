...
class BarriosProgressChart {
    ...
    calcularEstadisticasPorBarrio(datosPorBarrio) {
        ...
        Object.entries(datosPorBarrio).forEach(([barrio, datos]) => {
            ...
            const prediccionFinalizacion = this.predecirFinalizacion(progresoCorregido, velocidadProgreso, totalTerritorios - manzanasUnicas);
    ...
    manejarError(error) {
        ...
        if (this.ctx) {
            ...
            this.ctx.fillText('Error cargando gráfica de progreso', this.canvas.width / 2, this.canvas.height / 2);
            this.ctx.fillStyle = '#6B7280';
            this.ctx.font = '12px Arial';
            this.ctx.fillText('Verifique la conexión y recargue la página', this.canvas.width / 2, this.canvas.height / 2 + 25);
        }
    }
    /**
     * MÉTODOS PÚBLICOS
 ...
 * grafica.destruir();
 */ 
//# sourceMappingURL=grafica-progreso-barrios.js.map