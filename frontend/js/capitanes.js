  ...
  if (capitanesAMostrar.length === 0) {
    container.innerHTML = `
      <div class="empty-state" style="grid-column: 1 / -1;">
        ...
        <p class="empty-state__title">No hay salidas programadas</p>
        <p class="empty-state__desc">Usa el formulario de abajo para programar la primera salida con un capitán.</p>
      </div>
    `;
    return;
  }
...
async function guardarCapitan(e) {
  ...
  try {
    ...
    UI.showNotification(
      capitanEditando ? 'Salida actualizada correctamente' : 'Salida programada correctamente',
      'success'
    );
